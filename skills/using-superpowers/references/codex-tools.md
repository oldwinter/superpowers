...
本 reference 说明 multi-agent 工具的版本差异、spawn/fix/lifecycle 规则和模型路由约束。请优先以当前实际 tool list 为准；涉及 `spawn_agent`、`followup_task`、`wait_agent`、V1/V2 生命周期或模型 allowlist 时，保留下方英文 contract 的精确行为。
